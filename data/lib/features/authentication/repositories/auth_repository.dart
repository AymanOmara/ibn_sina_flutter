...
import 'package:data/features/authentication/mappers/forget_password_mappers.dart';
import 'package:data/features/authentication/mappers/registration_mapper.dart';
import 'package:data/features/authentication/mappers/token_mapper.dart';
import 'package:data/features/authentication/model/token.dart';
import 'package:data/features/authentication/request/email_verification_request.dart';
import 'package:data/features/authentication/request/forget_password_request.dart';
...
import 'package:data/features/authentication/request/verify_otp_request.dart';
...
//
//   @override
//   Future<Result<TokenEntity, NetworkException>> login(
//     String email,
//     String password,
//   ) async {
...
//       // if (data == 200) {
//       //   _userLocal.setAccessToken(data?.token ?? "");
//       //   _userLocal.setRefreshToken(data?.refreshToken ?? "");
//       // }
//       return Success(data.toEntity(data.toEntity()));
//     }, onFailure: (exception) {
